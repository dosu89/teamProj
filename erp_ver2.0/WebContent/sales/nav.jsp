...
<body>
	<nav>
		<ul class="nav nav-tabs justify-content-center text-center">
			...
			<li class="nav-item dropdown">
		    	<a class="nav-link dropdown-toggle active" data-bs-toggle="dropdown" role="button" aria-expanded="false">매출</a>
		    		<ul class="dropdown-menu">
		    			<li><a class="dropdown-item" href="sales">매출 달력</a></li>
		    			<li><a class="dropdown-item" href="/erp_ver2.0/sale">매출 분석</a></li>
		   			</ul>
			</li>
